...
public class MessageService implements Observable<MessageChangeEvent> {
    ...
    public void addMessage(Long idFrom, Long idTo, String messageText, Long idMessageThisRepliedTo) {
    ...
    public Iterable<Message> getAllMessagesBetweenTwoUsers(Long id1, Long id2) {
        ...
        Predicate<Message> p1 = m -> Objects.equals(m.getIdFrom(), id1) && Objects.equals(m.getIdTo(), id2);
        Predicate<Message> p2 = m -> Objects.equals(m.getIdFrom(), id2) && Objects.equals(m.getIdTo(), id1);

        return messages.stream().filter(p1.or(p2)).sorted(Comparator.comparing(Message::getTimeSent)).toList();
    }
