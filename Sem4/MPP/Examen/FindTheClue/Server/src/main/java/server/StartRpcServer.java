...
import persistence.hibernate.ConfigurationOrmRepository;
import persistence.jdbc.GameJdbcRepository;
import persistence.jdbc.PlayerJdbcRepository;
...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        PlayerRepository playerRepository = new PlayerJdbcRepository(serverProps);
        GameRepository gameRepository = new GameJdbcRepository(serverProps);
